...
class CarState(object):
  ...
  def update(self, cp):
    ...
    if self.CP.carFingerprint in TSS2_CAR:
      ...
      self.angle_steers = cp.vl["STEER_TORQUE_SENSOR"]['STEER_FRACTION'] - self.angle_offset
      angle_wheel = cp.vl["STEER_ANGLE_SENSOR"]['STEER_FRACTION'] + cp.vl["STEER_ANGLE_SENSOR"]['STEER_FRACTION']
      ...
      self.angle_steers = cp.vl["STEER_ANGLE_SENSOR"]['STEER_FRACTION'] + cp.vl["STEER_ANGLE_SENSOR"]['STEER_FRACTION']
